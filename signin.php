<?php
    define('PAGE_TITLE', 'Sign In | Docx Physiotherapy ');
    include 'inc/header.php';

?>


<div class="container-fluid con-signin">
    <div class="frame">
        <div class="nav">
            <ul class="links">
        ...
        <div ng-app ng-init="checked = false">
            ...
            <form class="form-signup" action="" method="post" name="form">
                ...
                <input type="submit" value="Sign Up" class="mt-3 btn  btn-block btn-primary">
            </form>
            <div class="success">
    ...
    <a id="refresh" value="Refresh" onClick="history.go()"> 
        <svg class="refreshicon" version="1.1" id="Capa_1" x="0px"
            y="0px" width="25px" height="25px" viewBox="0 0 322.447 322.447"
